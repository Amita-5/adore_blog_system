...
<div class="container" >
    <div class="content">
        <form action="adore.php" method="post" class="form" id="form" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label"><h4>Blog Name:</h4></label>
                  <input type="text" name="blog_name" class="form-control" id="exampleFormControlInput1">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Blog Content</label>
                 <textarea class="form-control" name="blog_content" id="exampleFormControlTextarea1" rows="3"></textarea>
            </div> 
            <div class="mb-3">
           ...
           <div class="mb-3">
                ...
                <select name="author" class="form-control" id="exampleFormControlTextarea1" required >
            ...
            <div class="mb-3">
                ...
                <input type="text" name="uploaded_by"  class="form-control" id="exampleFormControlInput1">
            </div>
            <div class="mb-3">
            ...
            <label for="exampleFormControlTextarea1" class="form-label">Status :</label>
                <select name="status" class="form-control" id="exampleFormControlTextarea1" required>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="adore.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Blog Content</label>
                 <textarea class="form-control" name="blog_content" id="exampleFormControlTextarea1" rows="3" > <?=$t["blog_content"] ?></textarea>
            </div> 
            <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Status :</label>
                <select name="status" class="form-control" id="exampleFormControlTextarea1" required>
                    <option value="ongoing"<?php if ($r["status"] == "ongoing") echo "selected"; ?>>ongoing</option>
                    <option value="paused" <?php if ($r["status"] == "paused") echo "selected"; ?>>paused</option>
                    <option value="completed"<?php if ($r["status"] == "completed") echo "selected"; ?>>completed</option>
                    <option value="purge"<?php if ($r["status"] == "purge") echo "selected"; ?>>purge</option>
                </select> 
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-nowrap">
                            ...
                            <tr>
                                    ...
                                    <th scope="col">Bio of speaker</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <i class="bi bi-pencil" ></i>Edit
                                         ...
                                         <a href="http://localhost:8012/adoreearth/adoreearth/page-blog.php?id=<?php echo $row["Id"]; ?>" class="btn btn-sm btn-neutral">View</a>             
